...
def process_create_experiment_arguments():
    ...
    parser.add_argument('--model_name', help="Model to use for feature extraction " +\
                        "[resnet18, resnet34, resnet50, vgg, vgg_pool5, vgg_fc6, resnet50_conv4]", default="resnet18")
    ...
    assert args.dataset_name in ["arthist", "classarch", "chrisarch", "artdl", "image_collation", "the_MET"],\
        "Wrong dataset given. Only ['arthist', 'classarch', 'chrisarch', 'artdl', 'image_collation', 'the_MET'] are allowed"
